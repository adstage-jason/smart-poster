...
public class TagViewer extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  setContentView(R.layout.main);
       ...
       intent.setClass(TagViewer.this, SmartActivity.class);
       Bundle bundle=new Bundle();
       bundle.putCharSequence("mTitle", mTitle.toString());
       bundle.putCharSequence("mTagContent", mTagContent.toString());
    ...
    void buildTagViews(NdefMessage[] msgs) {
       ...
       /* List<ParsedNdefRecord> records = (ParsedNdefRecord)msgs[0];
